...
public class TemperatureMinEvent extends EventObject implements TemperatureEventInterface {
    ...
    private final MeasuringPoint newValue;

    // The previous minimum temperature value.
    private final MeasuringPoint oldValue;
     ...
     */
    public TemperatureMinEvent(Object source, MeasuringPoint oldValue, MeasuringPoint newValue) {
        super(source);
        if (newValue == null) {
     ...
     */
    public MeasuringPoint getNewValue() {
        return newValue;
    }
     ...
     */
    public MeasuringPoint getOldValue() {
        return oldValue;
    }
