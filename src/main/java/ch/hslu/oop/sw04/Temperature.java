...
public class Temperature {
    ...
    public String getStateOfAggregation(String element) {
        return switch (element) {
            case "N" -> this.temperatureCelcius < -210.0 ? "fest" : this.temperatureCelcius < -196.0 ? "flüssig" : "gasförmig";
            case "Hg" -> this.temperatureCelcius < -38.83 ? "fest" : this.temperatureCelcius < 356.73 ? "flüssig" : "gasförmig";
            case "Pb" -> this.temperatureCelcius < 327.5 ? "fest" : this.temperatureCelcius < 1749 ? "flüssig" : "gasförmig";
